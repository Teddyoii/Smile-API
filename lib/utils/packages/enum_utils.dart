...
// adapted from https://github.com/rknell/flutterEnumsToString
class EnumToString {
...
const String WORD =
    '(?:[$UPPERCASE][$DIACRITICAL_MARK]*)?(?:[$LOWERCASE][$DIACRITICAL_MARK]*)+|(?:[$UPPERCASE][$DIACRITICAL_MARK]*)+(?![$LOWERCASE])|[$DIGIT]+|[$DINGBAT_BLOCK]|[^$NON_CHAR$GENERAL_PUNCTUATION$WHITESPACE]+';
